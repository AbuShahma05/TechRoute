...
const Skills2 = ({ activeSection, setActiveSection }) => {
    return (
        <div>
            ...
            {/* devops basics */}
            <p className="font-bold text-2xl pt-4">7. DevOps Basics:</p>
            <div className='pt-2 pl-6'>
                <button className={`bg-gray-400 text-black h-14 w-80 rounded-xl font-semibold text-lg cursor-pointer transition-all hover:scale-110 focus:outline-none
            ...
            <p className="font-bold text-2xl pt-4">8. Advanced Backend Skills:</p>
            <div className='pt-2 pl-6'>
                <button className={`bg-gray-400 text-black h-14 w-80 rounded-xl font-semibold text-lg cursor-pointer transition-all hover:scale-110 focus:outline-none
            ...
            {/* system design */}
            <p className="font-bold text-2xl pt-4">9. System Design:</p>
            <div className='pt-2 pl-6'>
                <button className={`bg-gray-400 text-black h-14 w-80 rounded-xl font-semibold text-lg cursor-pointer transition-all hover:scale-110 focus:outline-none
